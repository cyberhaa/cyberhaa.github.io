...
tags: [RaspberryPi, Backup]
description: "SD-Karte im laufenden Betrieb klonen mit piclone_cmd – ohne Herunterfahren. So sicherst du dein Raspberry Pi Smart Home per Live-Backup."
image:
...
![Zwei Raspberry Pi 4 Einplatinencomputer im Netzwerkschrank](/assets/img/posts/raspberry-pies.jpg){: .shadow .rounded-10 }
...
*Wenn dir die Grenzen des Pi irgendwann zu eng werden: Ich habe mein Smart Home auf einen [Mini-PC mit Unraid umgezogen]({% post_url 2025-06-22-mini-pc-vs-pi-unraid-switch %}) – und bereue nichts.*
