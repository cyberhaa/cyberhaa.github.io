...
Wer sein Smart Home auf einem Raspberry Pi betreibt, lebt gefährlich. SD-Karten sind nicht für 24/7-Schreibzugriffe (Log-Dateien!) gemacht. Irgendwann kommt der Tag, an dem nichts mehr geht – und meistens hat man dann kein aktuelles Backup zur Hand.
...
* **Kartenleser:** [SanDisk MobileMate USB 3.0]({{ site.data.hardware.usb_reader.url }})
* **Backup-Karte:** [SanDisk High Endurance microSD]({{ site.data.hardware.sd_card.url }}) (hält deutlich mehr Schreibzyklen aus)
