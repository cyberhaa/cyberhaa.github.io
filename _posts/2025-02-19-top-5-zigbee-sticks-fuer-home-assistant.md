...
Wenn du dein Smart Home aufbaust und Home Assistant mit Zigbee2MQTT nutzen willst, mach nicht den gleichen Fehler wie ich am Anfang. Kauf dir direkt den **[Sonoff Dongle-P *]({{ site.data.amazon.sonoff_zigbee_p.url }})**.

**Ganz wichtig:** Bestell dir unbedingt ein [kurzes USB-Verlängerungskabel *]({{ site.data.amazon.usb_1m_cable.url }}) (ca. 1 Meter) dazu! Steck den Stick niemals direkt in den USB-Port deines Raspberry Pi oder Mini-PCs. Die USB 3.0 Anschlüsse strahlen extrem stark ab und stören das 2,4 GHz Zigbee-Signal massiv. Mit dem Kabel dazwischen hast du sofort ein bombenfestes Netzwerk.
